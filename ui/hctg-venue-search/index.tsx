          ...
          venues.map((v, idx) => (
            ...
            >
              <div className="relative aspect-[16/9] w-full bg-slate-100">
                {v.imageUrl ? (
                  // Use a plain <img> instead of the SDK Image component so we can
                  // reliably enforce "fill the whole bubble" sizing inside ChatGPT.
                  <img
                    src={v.imageUrl}
                    alt={v.name}
                ...
                {/* Top-right explicit action (doesn't steal clicks from the card) */}
...
const root = document.getElementById("hctg-venue-search-root");
if (root) {
